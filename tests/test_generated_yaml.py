      ...
      template:
        ...
        if config['tolerations']:
            ...
            for toleration in config['tolerations']:
                ...
                if toleration['tolerationSeconds'] and toleration['effect'] == 'NoExecute':
                    yaml_content += f'\n            tolerationSeconds: {toleration["tolerationSeconds"]}'

        # Add basic affinity if specified
        if config['affinity']['preferredNodeKey'] or config['affinity']['requiredNodeKey']:
            yaml_content += '\n          affinity:'
            yaml_content += '\n            nodeAffinity:'
            
            if config['affinity']['requiredNodeKey'] and config['affinity']['requiredNodeValue']:
            ...
            if config['affinity']['preferredNodeKey'] and config['affinity']['preferredNodeValue']:
